...
# 📖 [TodoList-React PRJECT] <a name="about-project"></a>

**[Abiy TodoList-React]** This is a TodoList-React project created during my Microverse course. 
...
```
  git clone https://github.com/abiy006/TodoList-React.git
```
### Install
...
Feel free to check the [issues page](https://github.com/abiy006/TodoList-React/issues).
